...
class CoreController {
    ...
    @PostMapping("")
    public ResponseEntity<ResponseDto<Map<String, Object>>> customerCreate(@RequestBody CustomerDto body){
        int id = service.createCustomer(body);
        StatusDto statusDto = new StatusDto("test", 1, 200, -1, "");
        ResponseDto<Map<String, Object>> responseDto = new ResponseDto<>(statusDto, null, Map.of("id", id));
